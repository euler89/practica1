    ...
    while (netif_is_up(netif))
    {
        ...
        else if (dhcp_last_state != dhcp->state)
        {
            ...
            if (dhcp_last_state == DHCP_STATE_BOUND)
            {
            	...
            	/*ip_addr_debug_print(LWIP_DBG_ON, (&mqtt_addr));*/
...
int main(void)
{
   ...
   /* PRINTF("\r\n************************************************\r\n");
    ...
    if (sys_thread_new("app_thread", app_thread, &netif, PRINT_THREAD_STACKSIZE, PRINT_THREAD_PRIO) == NULL)
    {
